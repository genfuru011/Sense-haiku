        ...
        <>
            ...
            {currentUser && location.pathname !== '/new' && (
                <div className="sm:hidden fixed bottom-6 right-6 z-50">
                    <Link 
                        to="/new" 
                        className="flex items-center justify-center bg-primary hover:bg-primary-light text-white rounded-full shadow-xl h-16 w-16 transition-all duration-200 hover:scale-110"
                        aria-label="新しい句を詠む"
                    >
